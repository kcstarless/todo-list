...
function bindAddProjectEvent() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    (0,_project__WEBPACK_IMPORTED_MODULE_2__.createProject)(projectTitle);
    modal.style.display = "none";
    sidebarProject();
