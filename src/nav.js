import { getProjectTodoList } from './ListManager';
...
function bindAddTaskEvent() {
    ...
    addTaskButton.addEventListener('click', () => {
        ...
        const projects = getProjectList();
        projects.forEach(project => { // populate select priority with current projects
    ...
    form.addEventListener('submit', (event) => {
        ...
        const taskPriority = document.getElementById('task-priority').value === 'true'; 
        const projectTitle = document.getElementById('project-title').value;
        
        // Convert the date to the desired format
        const formattedDate = format(parse(taskDate, 'yyyy-MM-dd', new Date()), 'dd-MM-yyyy');

        createTodo(taskTitle, taskDesc, formattedDate, taskPriority, false, projectTitle);
